...
export default {
  getAllBoards: wrapperCont(getAllBoards),
  getOneBoard: wrapperCont(getOneBoard),
  createBoard: wrapperCont(createBoard),
  editBoard: wrapperCont(editBoard),
  deleteBoard: wrapperCont(deleteBoard),
  //
  createColumn: wrapperCont(createColumn),
  editColumn: wrapperCont(editColumn),
  deleteColumn: wrapperCont(deleteColumn),
  //
  createTask: wrapperCont(createTask),
  editTask: wrapperCont(editTask),
  deleteTask: wrapperCont(deleteTask),
};
